@echo off
if "%1"=="" (
    echo Usage: build_with_file.bat [test_file_name]
    echo Example: build_with_file.bat input.test
    echo Example: build_with_file.bat comprehensive_test.test
    exit /b 1
)
...
echo.
echo Step 5: Running TestLang++ Compiler with %TEST_FILE%...
call java -cp "target\classes;D:\SLIIT\semester_4\PP\ASSIGNMENT\java-cup-bin-11b-20160615\java-cup-11b-runtime.jar" com.testlangpp.Main %TEST_FILE%
if errorlevel 1 (
